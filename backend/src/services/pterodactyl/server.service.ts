...
export const suspendPterodactylServer = async (pterodactylServerId: number): Promise<void> => {
  await pterodactylRequest<unknown>(`/api/application/servers/${pterodactylServerId}/suspend`, {
    method: 'POST'
  });
};
